...
the_bill_simmons_podcast = Podcast.create!(name: "The Bill Simmons Podcast", publisher: "The Ringer", description: "HBO and The Ringer's Bill Simmons hosts the most downloaded sports podcast of all time, with a rotating crew of celebrities, athletes, and media staples, as well as mainstays like Cousin Sal, Joe House, and a slew of other friends and family members who always happen to be suspiciously available.", link: "https://art19.com/shows/the-bill-simmons-podcast")
clublife = Podcast.create!(name: "CLUBLIFE", publisher: "Tiësto", description: "Subscribe to CLUBLIFE by Tiësto for an hour of the best club tracks from around the world with your favorite DJ. For more info about Tiësto please visit www.tiesto.com", link: "https://www.tiesto.com/")
ted_talks_daily = Podcast.create!(name: "TED Talks Daily", publisher: "TED", description: "Want TED Talks on the go? Every weekday, this feed brings you our latest talks in audio format. Hear thought-provoking ideas on every subject imaginable -- from Artificial Intelligence to Zoology, and everything in between -- given by the world's leading thinkers and doers. This collection of talks, given at TED and TEDx conferences around the globe, is also available in video format.", link: "https://www.ted.com/talks")
hidden_brain = Podcast.create!(name: "Hidden Brain", publisher: "NPR", description: "Shankar Vedantam uses science and storytelling to reveal the unconscious patterns that drive human behavior, shape our choices and direct our relationships.", link: "https://www.npr.org/series/423302056/hidden-brain")
the_tim_ferriss_show = Podcast.create!(name: "The Tim Ferriss Show", publisher: "Tim Ferriss", description: "Tim Ferriss is a self-experimenter and bestselling author, best known for The 4-Hour Workweek, which has been translated into 40+ languages. Newsweek calls him \"the world's best human guinea pig,\" and The New York Times calls him \"a cross between Jack Welch and a Buddhist monk.\" In this show, he deconstructs world-class performers from eclectic areas (investing, chess, pro sports, etc.), digging deep to find the tools, tactics, and tricks that listeners can use", link: "https://tim.blog/podcast/")
